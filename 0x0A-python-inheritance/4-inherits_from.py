#!/usr/bin/python3
""" Contains function is_inherits_from(obj, a_class) 
...
def inherits_from(obj, a_class):
    """ Return True if object returns true if its an instance that inherited directly or indirectly from a_class """
